...
public class ApiRoute {
    ...
    public static final String API_GET_CAMPAIGNS_BY_STATE = "apigetcampaignsbystate";
    public static final String API_GET_CAMPAIGNS_BY_CATEGORY = "apigetcampaignsbycategory";
