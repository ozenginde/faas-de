...
import com.faas.core.base.model.ws.scenario.details.content.ScenarioDataWSModel;
import com.faas.core.base.model.ws.scenario.details.content.ScenarioDetailsWSModel;
...
public class ScenarioDetailsMiddleware {
    ...
    public ScenarioDetailsWSModel getScenarioDetails(long userId, String scenarioId) {

        ScenarioDetailsWSModel response = new ScenarioDetailsWSModel();
        GeneralWSModel general = new GeneralWSModel();

        ScenarioDetailsWSDTO scenarioDetailsWSDTO = scenarioDetailsFramework.getScenarioDetailsService(scenarioId);
        if (scenarioDetailsWSDTO != null){
            response.setScenarioDetails(scenarioDetailsWSDTO);
        }

        general.setOperation("getScenarioDetails");
