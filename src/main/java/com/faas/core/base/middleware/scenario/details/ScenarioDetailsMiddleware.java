...
public class ScenarioDetailsMiddleware {
    ...
    public ScenarioElementWSModel getScenarioElement(long userId, String scenarioId) {

        ScenarioElementWSModel response = new ScenarioElementWSModel();
        GeneralWSModel general = new GeneralWSModel();

        ScenarioElementWSDTO scenarioElementWSDTO = scenarioDetailsFramework.getScenarioElementService(scenarioId);
        if (scenarioElementWSDTO != null){
            response.setScenarioElement(scenarioElementWSDTO);
        }
