package com.faas.core.base.middleware.direktor.operation;

import com.faas.core.base.framework.direktor.operation.DirektorOperationFramework;
...
@Component
public class DirektorOperationMiddleware {


    @Autowired
    DirektorOperationFramework direktorOperationFramework;
