package com.faas.core.base.middleware.direktor.session;

import com.faas.core.base.framework.direktor.session.DirektorSessionFramework;
...
@Component
public class DirektorSessionMiddleware {


    @Autowired
    DirektorSessionFramework direktorSessionFramework;
