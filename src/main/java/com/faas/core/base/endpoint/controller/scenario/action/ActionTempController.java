package com.faas.core.base.endpoint.controller.scenario.action;

import com.faas.core.base.middleware.scenario.action.ActionTempMiddleware;
import com.faas.core.base.model.ws.scenario.action.ActionTempWSModel;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/scenario/temp/action/")
