package com.faas.core.base.endpoint.controller.process.details.temp;

import com.faas.core.base.middleware.process.details.temp.ProcessTempMiddleware;
import com.faas.core.base.model.ws.process.details.temp.*;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/base/process/details/temp/")
