...
import com.faas.core.base.middleware.dashboard.inquiry.DashboardInquiryMiddleware;
...
public class DashboardInquiryController {
    ...
    @Autowired
    DashboardInquiryMiddleware dashboardInquiryMiddleware;
    ...
    public ResponseEntity<?> getDashboardInquiries(@RequestParam long userId,
        ...
        DashboardInquiryWSModel response = dashboardInquiryMiddleware.getDashboardInquiries(userId,reqPage,reqSize);
