...
public class ScenarioDetailsController {
    ...
    @RequestMapping(value = BaseRoute.GET_SCENARIO_DETAILS, method = RequestMethod.POST)
    public ResponseEntity<?> getScenarioDetails(@RequestParam long userId,
                                                @RequestParam String scenarioId) {

        ScenarioDetailsWSModel response = scenarioDetailsMiddleware.getScenarioDetails(userId,scenarioId);
