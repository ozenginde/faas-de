...
public class CampaignClientController {
    ...
    public ResponseEntity<?> getCampaignClients(@RequestBody GetClientRequest getClientRequest) {

        ClientWSModel response = campaignClientMiddleware.getCampaignClients(getClientRequest);
