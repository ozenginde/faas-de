...
public class ProcessScenarioController {
    ...
    public ResponseEntity<?> createProcessScenarioData(@RequestParam long userId,
        ...
        ProcessScenarioDataWSModel response = processScenarioMiddleware.createProcessScenarioData(userId,processId,scenarioId,dataTypeId,value);
    ...
    public ResponseEntity<?> updateProcessScenarioData(@RequestParam long userId,
        ...
        ProcessScenarioDataWSModel response = processScenarioMiddleware.updateProcessScenarioData(userId,processId,scenarioId,dataId,dataTypeId,value);
