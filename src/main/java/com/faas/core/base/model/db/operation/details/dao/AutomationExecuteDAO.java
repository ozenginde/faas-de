...
public class AutomationExecuteDAO {
    ...
    public AutomationExecuteDAO() {
    }

    public AutomationExecuteDAO(String executeId, List<ScenarioExecuteDataDAO> executeDatas, long uDate, long cDate, int status) {
