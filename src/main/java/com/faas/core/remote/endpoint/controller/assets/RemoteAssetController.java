package com.faas.core.remote.endpoint.controller.assets;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/remote/asset/")
public class RemoteAssetController {
    ...
    public ResponseEntity<?> apiAgentLogin(@RequestParam long agentId) {
        ...
        ApiAgentWSModel response = remoteAssetService.remoteAssetService(agentId);
