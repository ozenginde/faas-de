package com.faas.core.remote.endpoint.controller.robot.content;
...
import com.faas.core.remote.service.robot.content.RobotService;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/remote/robot/")
public class RobotController {
    ...
    public ResponseEntity<?> apiAgentLogin(@RequestParam long agentId) {
        ...
        ApiAgentWSModel response = robotService.apiAgentLogin(agentId);
