package com.faas.core.remote.endpoint.controller.pwa.session;
...
import com.faas.core.remote.service.pwa.session.PwaSessionService;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/remote/pwa/session/")
public class PwaSessionController {
    ...
    public ResponseEntity<?> apiAgentLogin(@RequestParam long agentId) {
        ...
        ApiAgentWSModel response = pwaSessionService.apiAgentLogin(agentId);
