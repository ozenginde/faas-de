package com.faas.core.remote.endpoint.controller.app.flow;

import com.faas.core.api.model.ws.agent.content.ApiAgentWSModel;
import com.faas.core.remote.service.app.flow.AppFlowService;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/remote/app/flow/")
public class AppFlowController {
    ...
    public ResponseEntity<?> apiAgentLogin(@RequestParam long agentId) {
        ...
        ApiAgentWSModel response = appFlowService.apiAgentLogin(agentId);
