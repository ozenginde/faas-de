...
public class ApiSmsTempWSDTO {

    private ApiSmsAccountWSDTO smsAccount;
    private List<ClientPhoneDBModel> phones;
    private List<SmsMessageTempDBModel>smsTemps;

    public ApiSmsTempWSDTO() {
    }

    public ApiSmsTempWSDTO(ApiSmsAccountWSDTO smsAccount, List<ClientPhoneDBModel> phones, List<SmsMessageTempDBModel> smsTemps) {
