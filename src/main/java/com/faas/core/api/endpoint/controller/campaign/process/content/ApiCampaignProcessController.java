package com.faas.core.api.endpoint.controller.campaign.process.content;

import com.faas.core.utils.config.ApiRoute;
import com.faas.core.api.middleware.campaign.process.content.ApiCampaignProcessMiddleware;
...
@Controller
@RequestMapping(value = AppConstant.API_VERSION + "/api/process/")
