...
public class ApiScenarioController {
    ...
    public ResponseEntity<?> apiGetScenarioDetails(@RequestParam long agentId,
        ...
        ApiScenarioDetailsWSModel response = apiScenarioMiddleware.apiGetScenarioDetails(agentId,sessionId,scenarioId);
    ...
    public ResponseEntity<?> apiGetScenarioActions(@RequestParam long agentId,
        ...
        ApiScenarioActionWSModel response = apiScenarioMiddleware.apiGetScenarioActions(agentId,sessionId,scenarioId);
    ...
    public ResponseEntity<?> apiGetScenarioAction(@RequestParam long agentId,
        ...
        ApiScenarioActionWSModel response = apiScenarioMiddleware.apiGetScenarioAction(agentId,sessionId,processId);
    ...
    public ResponseEntity<?> apiGetScenarioAutomations(@RequestParam long agentId,
        ...
        ApiScenarioAutomationWSModel response = apiScenarioMiddleware.apiGetScenarioAutomations(agentId,sessionId,processId);
    ...
    public ResponseEntity<?> apiGetScenarioAutomation(@RequestParam long agentId,
        ...
        ApiScenarioAutomationWSModel response = apiScenarioMiddleware.apiGetScenarioAutomation(agentId,sessionId,processId);
