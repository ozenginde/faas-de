...
public class ApiWappMessageController {
    ...
    public ResponseEntity<?> apiGetOperationWappMessage(@RequestParam long agentId,
        ...
        ApiOperationWappMessageWSModel response = apiWappMessageMiddleware.apiGetOperationWappMessage(agentId,sessionId,clientId);
    ...
    public ResponseEntity<?> apiGetWappMessages(@RequestParam long agentId,
        ...
        ApiWappMessageWSModel response = apiWappMessageMiddleware.apiGetWappMessages(agentId,sessionId,clientId,processId);
    ...
    public ResponseEntity<?> apiGetWappMessage(@RequestParam long agentId,
        ...
        ApiWappMessageWSModel response = apiWappMessageMiddleware.apiGetWappMessage(agentId,sessionId,clientId,processId,messageId);
    ...
    public ResponseEntity<?> apiUpdateWappMessage(@RequestParam long agentId,
        ...
        ApiWappMessageWSModel response = apiWappMessageMiddleware.apiUpdateWappMessage(agentId,sessionId,clientId,processId,messageId);
    ...
    public ResponseEntity<?> apiRemoveWappMessage(@RequestParam long agentId,
        ...
        ApiWappMessageWSModel response = apiWappMessageMiddleware.apiRemoveWappMessage(agentId,sessionId,clientId,processId,messageId);
    ...
    public ResponseEntity<?> apiGetWappMessageTemps(@RequestParam long agentId,
        ...
        ApiWappMessageTempWSModel response = apiWappMessageMiddleware.apiGetWappMessageTemps(agentId,sessionId,clientId,processId);
    ...
    public ResponseEntity<?> apiGetWappMessageTemp(@RequestParam long agentId,
        ...
        ApiWappMessageTempWSModel response = apiWappMessageMiddleware.apiGetWappMessageTemp(agentId,sessionId,clientId,processId,tempId);
