...
public class ApiInquiryMiddleware {
    ...
    public ApiAgentInquiryWSModel apiGetAgentInquiry(long agentId) {
        ...
        ApiAgentInquiryWSDTO agentInquiryWSDTO = apiInquiryFramework.apiGetAgentInquiryService(agentId);
    ...
    public ApiInquiryWSModel apiGetInquiries(long agentId) {

        ApiInquiryWSModel response = new ApiInquiryWSModel();
        GeneralWSModel general = new GeneralWSModel();

        List<ApiInquiryWSDTO> inquiryWSDTOS = apiInquiryFramework.apiGetInquiriesService(agentId);
    ...
    public ApiInquiryWSModel apiGetInquiriesByState(long agentId, String inquiryState) {

        ApiInquiryWSModel response = new ApiInquiryWSModel();
        GeneralWSModel general = new GeneralWSModel();

        List<ApiInquiryWSDTO> inquiryWSDTOS = apiInquiryFramework.apiGetInquiriesByStateService(agentId,inquiryState);
        if (inquiryWSDTOS != null){
            response.setInquiries(inquiryWSDTOS);
        }
